...
object TempleSceneLayout {
    ...
    fun plateFlower(index: Int): TemplePoint {
        ...
        val radius = .025f + .009f*index
        return TemplePoint(plate.x+cos(angle)*radius,plate.y+sin(angle)*radius*.45f-.012f)
    }
